...
impl TryFrom<(i16, i16, i16)> for Color {
    ...
    fn try_from(tuple: (i16, i16, i16)) -> Result<Self, Self::Error> {
        if tuple.0 > 255 || tuple.0 < 0 { return Err("Error".to_string()) }
        if tuple.1 > 255 || tuple.1 < 0 { return Err("Error".to_string()) }
        if tuple.2 > 255 || tuple.2 < 0 { return Err("Error".to_string()) }
...
impl TryFrom<[i16; 3]> for Color {
    ...
    fn try_from(arr: [i16; 3]) -> Result<Self, Self::Error> {
        if arr[0] > 255 || arr[0] < 0 { return Err("Error".to_string()) }
        if arr[1] > 255 || arr[1] < 0 { return Err("Error".to_string()) }
        if arr[2] > 255 || arr[2] < 0 { return Err("Error".to_string()) }
...
impl TryFrom<&[i16]> for Color {
    ...
    fn try_from(slice: &[i16]) -> Result<Self, Self::Error> {
        if slice.len() != 3 { return Err("Error".to_string()) }
        if slice[0] > 255 || slice[0] < 0 { return Err("Error".to_string()) }
        if slice[1] > 255 || slice[1] < 0 { return Err("Error".to_string()) }
        if slice[2] > 255 || slice[2] < 0 { return Err("Error".to_string()) }
